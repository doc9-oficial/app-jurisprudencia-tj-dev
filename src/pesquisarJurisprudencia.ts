...
interface PesquisarJurisprudenciaParams {
  parametro: string;
  filtro?: string;
}

async function pesquisarJurisprudencia(params: PesquisarJurisprudenciaParams): Promise<void> {
  try {
    ...
    console.log(`Executando pesquisarJurisprudencia com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Pesquisa jurisprudência nos Tribunais de Justiça concluído com sucesso",
      resultado: {
...
export default pesquisarJurisprudencia;
