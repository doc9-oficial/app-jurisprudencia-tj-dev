...
interface ObterAcordaoParams {
  parametro: string;
  filtro?: string;
}

async function obterAcordao(params: ObterAcordaoParams): Promise<void> {
  try {
    ...
    console.log(`Executando obterAcordao com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Obtém íntegra de acórdão específico concluído com sucesso",
      resultado: {
